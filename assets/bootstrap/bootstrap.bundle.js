  ...
  */
  ...
  class Tooltip extends BaseComponent {
    ...
    hide() {
      ...
      tip.classList.remove(CLASS_NAME_SHOW$2); // S'il s'agit d'un périphérique compatible tactile, nous supprimons le supplément
      // les auditeurs de souris vides que nous avons ajoutés pour le support iOS
  ...
  const CLASS_NAME_HIDE = "hide"; // @deprecatedConservéIciUniquementPourUneCompatibilitéArrière
